...
namespace lysa::ui {
    ...
    void StyleClassic::draw(const Widget &widget, Resource &resources, UIRenderer &renderer, const bool before) const {
    ...
    void StyleClassic::drawLine(const Line &widget, const StyleClassicResource &resource, UIRenderer &renderer) const {
        float4 color;
    ...
    void StyleClassic::drawButton(const Button &widget, StyleClassicResource &resource, UIRenderer &renderer) const {
    ...
    void StyleClassic::drawToggleButton(ToggleButton &widget, StyleClassicResource &resources, UIRenderer &renderer) const {
    ...
    //----------------------------------------------
        void GLayoutVector::DrawArrow(GArrow&W, GLayoutVectorResource&, UIRenderer&, float)
        {
    ...
    //----------------------------------------------
        void GLayoutVector::DrawCheckmark(GCheckmark&W, GLayoutVectorResource&, UIRenderer&, float)
        {
    ...
    //----------------------------------------------
        void GLayoutVector::DrawTextEdit(GTextEdit&W, GLayoutVectorResource&, UIRenderer&, floatRESR)
        {
    ...
    //----------------------------------------------
        void GLayoutVector::DrawProgressBar(GProgressBar&W, GLayoutVectorResource&, UIRenderer&, float)
        {
    ...
    //--------------------------------------------------------------------------
        void GLayoutVector::DrawSelection(GSelection&W, UIRenderer&D,
    ...
    //--------------------------------------------------------------------------
        void GLayoutVector::DrawTrackBar(GTrackBar&W, UIRenderer&D,
                                         GLayoutVectorResource&)
        {
    ...
    //--------------------------------------------------------------------------
        void GLayoutVector::DrawTabs(GTabs&W, UIRenderer&D,
                                     GLayoutVectorResource&)
        {
            D.SetPenColor(shadowBright);
            if (W.Childs().Count() == 0) {
    ...
    //--------------------------------------------------------------------------
        void GLayoutVector::DrawTabButton(GTabButton&W, UIRenderer&D,
    ...
    //--------------------------------------------------------------------------
        void GLayoutVector::DrawRoundButton(GRoundButton&W, UIRenderer&D,
                                            GLayoutVectorResource&)
        {
    ...
    //--------------------------------------------------------------------------
        void GLayoutVector::DrawGridCell(GGridCell&W, UIRenderer&D,
                                         GLayoutVectorResource&RES)
        {
